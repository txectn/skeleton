...
#         Lookup order:
#         1. If email exists, find by email.
#         2. Otherwise, find by provider_user_id.
#         3. If no user is found, create one.
...
#         provider_user_id = provider_user["provider_user_id"]
#         first_name = provider_user.get("first_name") or ""
#         last_name = provider_user.get("last_name") or ""
...
#             logger.info(
#                 "Created user (email=%s, provider_user_id=%s).",
#                 email,
#                 provider_user_id,
#             )
...
#             logger.warning(
#                 "User creation race condition detected. %s",
#                 exc,
#             )
